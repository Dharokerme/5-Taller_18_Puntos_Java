...
public class _17Electrodomestico {
    int precio;
    String color;
    ...
    public _17Electrodomestico(int precio, int peso){
        this.peso = peso;
        this.precio = precio;
        this.consumoEnergetico = consumoDefault;
        this.color = colorDefault;
    ...
    public _17Electrodomestico(int precio, int peso, char consumoEnergetico, String color){
        this.peso = peso;
        this.precio = precio;
